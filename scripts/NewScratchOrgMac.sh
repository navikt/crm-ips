...
echo "\nInstallerer crm-platform-base 0.310.0"
sf package install --package 04tQC000001aJA1YAM -r --installation-key $3 --wait 4 --publish-wait 4

echo "\nInstallerer crm-platform-access-control 0.179.0"
sf package install --package 04tQC000001agEfYAI -r --installation-key $3 --wait 4 --publish-wait 4

echo "\nInstallerer crm-thread-view 0.8.0"
...
echo "\nInstallerer crm-henvendelse-base 0.42.0"
sf package install --package 04tQC000001aXhdYAE -r --installation-key $3 --wait 4 --publish-wait 4

echo "\nInstallerer crm-platform-integration 0.174.0"
sf package install --package 04tQC000001ZkYrYAK --no-prompt --installation-key $3 --wait 30 --publish-wait 30
...
echo "\nInstallerer crm-henvendelse 0.209.0"
sf package install --package 04tQC000001YzwXYAS -r --installation-key $3 --wait 4 --publish-wait 4
